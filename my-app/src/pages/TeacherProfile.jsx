...
import { User, Shield, LogOut, GraduationCap, ChevronRight } from 'lucide-react';
import axios from 'axios';
import MainLayout from '../components/MainLayout';
import './TeacherProfile.css';

const TeacherProfile = ({ user: initialUser, theme, onLogout, setUser }) => {
    const navigate = useNavigate();
    const [user, setLocalUser] = useState(initialUser || null);
    const [imageError, setImageError] = useState(false);

    // ✅ GET TOKEN from localStorage (Same logic as Profile.jsx)
    const getToken = () => {
